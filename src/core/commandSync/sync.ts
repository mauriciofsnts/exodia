...
// defines. Prefix-only commands are excluded (buildDesiredCommands filters them).
// The recorded signatures act as a fast path — when they already match what we'd
// register, we skip the Discord round trip entirely.
